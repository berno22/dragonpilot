...
def controlsd_thread(sm=None, pm=None, can_sock=None):
  ...
  while True:
    ...
    if not dragon_toyota_stock_dsu and CS.brakePressed and sm['plan'].vTargetFuture >= STARTING_TARGET_SPEED and CP.openpilotLongitudinalControl and CS.vEgo < 0.3:
